...
from clap_modules.clap import CLAP
from clap_modules.mapper import get_clapcap
import math
...
_CLAP_MODELS = {
    '2022': '/home/royhirsch/.cache/huggingface/hub/models--microsoft--msclap/snapshots/c47d441165daa21986ead0850660917636a81775/CLAP_weights_2022.pth',
    '2023': '/home/royhirsch/.cache/huggingface/hub/models--microsoft--msclap/snapshots/c47d441165daa21986ead0850660917636a81775/CLAP_weights_2023.pth',
}
...
class ClapModel():
    ...
    def __init__(self, model_name, device):
        ...
        self.supported_versions = _CLAP_MODELS.keys()
        if model_name not in self.supported_versions:
            raise ValueError(f"The version {model_name} is not supported. The supported versions are {str(self.supported_versions)}")
        ...
        self.config_as_str = (Path(__file__).parent / f"configs/config_{model_name}.yml").read_text()

        self.model_fp = _CLAP_MODELS[model_name]
        self.device = device
        if 'clapcap' in  model_name:
    ...
    def load_clap(self):
        ...
        print(type(args.text_model))
        print(args.text_model) #todo
